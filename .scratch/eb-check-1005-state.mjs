...
console.log("=== Full campaign 1005 detail ===");
const r = await call("GET", "/api/campaigns/1005");
console.log(JSON.stringify(r.json, null, 2));
console.log("\n=== Schedule ===");
console.log(JSON.stringify((await call("GET", "/api/campaigns/1005/schedule")).json, null, 2));
