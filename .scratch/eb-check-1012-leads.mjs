...
console.log("=== Campaign 1012 detail ===");
const r = await call("GET", "/api/campaigns/1012");
console.log(JSON.stringify(r.json, null, 2));

console.log("\n=== Trying /api/campaigns/1012/leads ===");
console.log(JSON.stringify(await call("GET", "/api/campaigns/1012/leads"), null, 2));

console.log("\n=== Trying /api/campaigns/1012/leads/leads ===");
console.log(JSON.stringify(await call("GET", "/api/campaigns/1012/leads/leads"), null, 2));
